...
public class HelpUtils {
    ...
    public static class AboutDialog extends android.app.DialogFragment {
        ...
        public static void showOpenSourceLicenses(Activity activity) {
            ...
            android.app.Fragment prev = fm.findFragmentByTag("dialog_licenses");
            if (prev != null) {
                ft.remove(prev);
            }
            ft.addToBackStack(null);
    ...
    public static class OpenSourceLicensesDialog extends android.app.DialogFragment {
    ...
    public static void showHelp(Activity activity) {
        android.app.FragmentManager fm = activity.getFragmentManager();
        android.app.FragmentTransaction ft = fm.beginTransaction();
        android.app.Fragment prev = fm.findFragmentByTag("dialog_help");
        if (prev != null) {
            ft.remove(prev);
        }
        ft.addToBackStack(null);
    ...
    public static class HelpDialog extends android.app.DialogFragment {
    ...
    public static void showEula(Activity activity) {
            android.app.FragmentManager fm = activity.getFragmentManager();
            android.app.FragmentTransaction ft = fm.beginTransaction();
            android.app.Fragment prev = fm.findFragmentByTag("dialog_eula");
            if (prev != null) {
                ft.remove(prev);
            }
            ft.addToBackStack(null);
    ...
    public static class EulaDialog extends android.app.DialogFragment {
