...
public class TestActivity extends FragmentActivity {
    ...
    public static class PagerTestFragment extends Fragment {
         ...
         * as an argument.
         */
        static PagerTestFragment newInstance(int num) {
            PagerTestFragment f = new PagerTestFragment();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View v = inflater.inflate(R.layout.fragment_pager_question, container, false);
